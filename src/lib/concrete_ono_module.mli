(** Concrete ono runtime module.
    ...
    Bundles the externs exposed to a Wasm program under concrete execution:
    grid accessors, simulation parameters and the chosen output back-end
    (text or GUI).
...
(** [m use_graphical_window steps display_last config_file speed] builds the
    ...
    - [use_graphical_window]: when [true], output goes through the Raylib
      GUI; otherwise to stdout.
